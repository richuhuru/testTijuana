...
function systemPrompt(restaurant) {
  ...
  return [
    ...
    `Si es 'para llevar' (entrega a domicilio), pregunta la direccion de entrega y registrala con set_address antes de cobrar; si es 'para recoger', no pidas direccion. Incluye tipo y direccion en el resumen.`,
...
const TOOLS = [
  ...
  { name: "get_order", description: "Devuelve el pedido actual y el total.",
    parameters: { type: "object", properties: {} } },
  { name: "set_address", description: "Registra la direccion de entrega cuando la orden es para llevar.",
